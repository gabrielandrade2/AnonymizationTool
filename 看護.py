...
if __name__ == '__main__':
    ...
    force_remove = ["患者番号", "発生者氏名", "更新者氏名", "患者ID"]

    directory ="C:\\Users\\精神科医局\\Desktop\\カルテデータ\\2018~\\看護\\"
    ...
    for file in files:
        ...
        # 看護SOAPフォーカス_1199501_20191001_20221212
        i += 1
        # output_file = re.sub(r"看護SOAPフォーカス_[0-9]+",r"看護SOAPフォーカス_ANON" + str(i), filename)
