...
if __name__ == '__main__':
    ...
    force_remove = ["患者番号", "発生者氏名", "更新者氏名"]

    directory ="C:\\Users\\精神科医局\\Desktop\\カルテデータ\\2018~\\プログレス\\"
    ...
    for file in files:
        ...
        # プログレスノート_1199501_20191001_20221212
        i += 1
        # output_file = re.sub(r"プログレスノート_[0-9]+",r"プログレスノート_ANON" + str(i), filename)
    ...
    # print(deidentify("＃ 適応障害　当院精神科高原Dr"))
    # 20180101_20221219
